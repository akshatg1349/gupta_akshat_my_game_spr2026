#https://github.com/akshatg1349/gupta_akshat_my_game_spr2026
#Design goals: make a player, mob, coins, and walls to fill up the screen
#The background is supposed to be blue for contrast
...
#Copilot is the only source of AI that was used
#There are no links because Copilot does not have any links
# check the code to see what parts of main.py and sprites.py were generated by Copilot
