...
class Game:
    ...
    def draw(self):
        ...
        if self.score <= 0:
            ...
            pg.draw.rect(self.screen, BLUE, (0, TILESIZE*2 - 10, WIDTH, 80))
            self.draw_text("You Lose!", 32, RED, WIDTH/1.25, TILESIZE)
        ...
        self.draw_text(str(self.player.pos), 24, WHITE, WIDTH/2, HEIGHT-TILESIZE*8)
